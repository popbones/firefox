...
// X-macro list for all mozinference library functions
...
struct MOZ_ONLY_USED_TO_AVOID_STATIC_CONSTRUCTORS LlamaLibWrapper {
  ...
  // Function pointers generated from X-macros
