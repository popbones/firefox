...
Fires when shared profile data in a profile group changes due to another running profile instance. Only triggers for remote changes and after a tracked data-collection preference actually changes.
